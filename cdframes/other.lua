...
local DATA = {
	...
	["Net-o-Matic"] = {duration = 10*60, icon = "INV_Misc_Net_01"},
	["Cloaking"] = {duration = 60*60, icon = "INV_Gizmo_01"},
	["Speed"] = {duration = 30*60, icon = "INV_Misc_Pocketwatch_01"},
	["Goblin Mortar"] = {duration = 10*60, icon = "INV_Musket_01"},
	["Immune Root/Snare/Stun"] = {duration = 5*60, icon = "INV_Jewelry_Trinketpvp_02"},
	["Immune Charm/Fear/Polymorph"] = {duration = 5*60, icon = "INV_Jewelry_Trinketpvp_02"},
	["Immune Fear/Polymorph/Stun"] = {duration = 5*60, icon = "INV_Jewelry_Trinketpvp_02"},
	["Immune Fear/Polymorph/Snare"] = {duration = 5*60, icon = "INV_Jewelry_Trinketpvp_02"},
	["Immune Charm/Fear/Stun"] = {duration = 5*60, icon = "INV_Jewelry_Trinketpvp_02"},

	["First Aid"] = {duration = 60, icon = "INV_Misc_Bandage_11"},
	
	["Goblin Rocket Boots"] = {duration = 5*60, icon = "INV_Gizmo_Rocketboot_01"},
	["Gnomish Rocket Boots"] = {duration = 30*60, icon = "INV_Boots_02"},
	["Flee"] = {duration = 5*60, icon = "INV_Misc_Bone_Elfskull_01"},
	["Furbolg Medicine Pouch"] = {duration = 20*60, icon = "INV_Misc_Bag_11"},
	["Reckless Charge"] = {duration = 20*60, icon = "INV_Helmet_49"},
	["Gnomish Mind Control Cap"] = {duration = 30*60, icon = "INV_Helmet_49"},
	
	["Free Action"] = {duration = 2*60, icon = "Inv_Potion_04"},
	["Healing Potion"] = {duration = 2*60, icon = "Inv_Potion_54"},
	["Living Free Action"] = {duration = 2*60, icon = "Inv_Potion_07"},
	["Restoration"] = {duration = 2*60, icon = "Inv_Potion_01"},
	["Invulnerability"] = {duration = 2*60, icon = "Inv_Potion_62"},
	
	["Sleep"] = {duration = 60, icon = "INV_Misc_Dust_02"},
	["Iron Grenade"] = {duration = 60, icon = "INV_Misc_Bomb_08"},
	["Thorium Grenade"] = {duration = 60, icon = "INV_Misc_Bomb_08"},
	...
	["Diamond Flask"] = {duration = 6*60, icon = "INV_Drink_01", classes = 'Warrior'},
	...
	["Replenish Mana"] = {duration = 2*60, icon = "INV_Misc_Gem_Ruby_01", classes = 'Mage'},
	...
	["Blind"] = {duration = (3*60+30), icon = "Spell_Shadow_MindSteal", classes = 'Rogue'},
	["Distract"] = {duration = 30, icon = "Ability_Rogue_Distract", classes = 'Rogue'},
	["Stealth"] = {duration = 6, icon = "Ability_Stealth", classes = 'Rogue'},
	["Vanish"] = {duration = (3*60+30), icon = "Ability_Vanish", classes = 'Rogue'},
	["Blade Flurry"] = {duration = 2*60, icon = "Ability_Warrior_PunishingBlow", classes = 'Rogue'},
	["Adrenaline Rush"] = {duration = 5*60, icon = "Spell_Shadow_ShadowWordDominate", classes = 'Rogue'},
	...
	["Restore Energy"] = {duration = 5*60, icon = "INV_Drink_Milk_05", classes = 'Rogue'},
	...
	["Spell Lock"] = {duration = 30, icon = "Spell_Shadow_MindRot", classes = 'Warlock'},
